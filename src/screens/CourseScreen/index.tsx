  ...
  return (
    <>
      <View>
        <Modal isVisible={isModalVisible}>
          <Flex style={style.modal} direction="column" align="start">
            <Text style={{margin: 5, ...style.modalTitle}}>Search filter</Text>
            ...
            <ScrollView horizontal={true}>
              <FieldChip label="Beginner" color={color.darkGrey} />
              <Text style={{marginRight: 5}} />
              <FieldChip label="Intermediate" color={color.darkGrey} />
              <Text style={{marginRight: 5}} />
              <FieldChip label="Advanced" color={color.darkGrey} />
            </ScrollView>
      ...
      <Flex direction="column" align="start" style={myStyle.container}>
        ...
        <Text style={myStyle.text}>Total: 5 courses</Text>
